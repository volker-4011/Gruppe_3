...
model_svm <- svm(Umsatz ~ 
                   ...
                   Temperatur_Eisig + Temperatur_Fruehling + Temperatur_Heisser_Tag + Temperatur_Kalter_Tag + Temperatur_Sommertag + 
                   Temperatur_Vegetationstag + Temperatur_NA +
                   Ferien + Feiertag + Wochenende + Umsatz_naiv + Umsatz_mean, train_dataset)
```
